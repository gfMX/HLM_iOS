...
class ChatUserListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.chat_userImage.contentMode = UIViewContentMode.scaleAspectFit
    ...
    func getUserChatDetails(){
        ...
        for i in 0 ..< listUsers.count {
            ...
            self.ref.child("chats_resume").child(self.listChats[i]).observeSingleEvent(of: .value, with: {(snapshot) in
                ...
                let user_name = value?.value(forKey: "name") as! String
                let user_pic = value?.value(forKey: "photoUrl") as! String
                let user_message = value?.value(forKey: "text") as! String
                
                let user = Users(name: user_name, photo: user_pic, message: user_message)!
                ...
                print("And the value \(i) is: \(user_name) \n \(user_pic) \n Text: \(user_message)")
            })
        }
